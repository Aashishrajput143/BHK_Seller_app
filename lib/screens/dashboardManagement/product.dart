    ...
    return Obx(
      () => SingleChildScrollView(
        child: GridView.builder(
          ...
          itemCount:
              (controller.getProductModel.value.data?.docs?.length ?? 0) >= 4
                  ? 4
                  : (controller.getProductModel.value.data?.docs?.length ?? 0),
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () {
                Get.toNamed(RoutesClass.gotoProductDetailScreen(), arguments: {
                  "productid": controller
                          .getProductModel.value.data?.docs?[index].productId ??
                      0
                });
              },
              child: Stack(
                children: [
                  Column(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Get.toNamed(RoutesClass.gotoProductDetailScreen(),
                              arguments: {
                                "productid": controller.getProductModel.value
                      ...
                      Text(
                        controller.getProductModel.value.data?.docs?[index]
                                .productName ??
                            "",
